    ...
    return (
        <Form className="col-6 mx-5 px-5" onSubmit={validate(handleSubmit)}>
            ...
            <FormGroup className="py-3">
                ...
                {dateError && <small className="d-block form-text text-danger mt-2">You must choose the date</small>}
            </FormGroup>
            ...
            <FormGroup className="py-3">
                ...
                <FormControl
                    ...
                    defaultValue={mainContent} onChange={setMainContent}
                />
                {mainContentError && <small className="d-block form-text text danger mt-2">Content can't be empty</small>}
            </FormGroup>
